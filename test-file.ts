...
const wallet = new ethers.Wallet('', web3 as any);
...
async function attestation() {
  const grant = new Grant({
    data: {
      communityUID: '0xc85c9f504e60550bc45e87ab71986c36f046e8f8aa8085bbe07d37825bcbb10a',
    },
    refUID: '0xc3594f22568f292c9ac55e4181fd79e07e9a42d3c630906d734aecfc0fe9c19b',
...
// (async () => {
//   const resolver = await GAP.getCommunityResolver((web3 as any), 11155420);
