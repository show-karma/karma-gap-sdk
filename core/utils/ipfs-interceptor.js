...
exports.IPFSInterceptor = void 0;
const Project_1 = require("../class/entities/Project");
function IPFSInterceptor(client) {
    ...
    methods.forEach((method) => {
        ...
        client[method] = async (...args) => {
            ...
            for (const result of [results[0]]) {
                if (!result.project)
                    continue;
                if (result instanceof Project_1.Project) {
...
exports.IPFSInterceptor = IPFSInterceptor;
