...
export interface IGrantResponseUpdate extends IAttestationResponse {
  data: {
    text: string;
    title: string;
    type: "grant-update";
...
export interface IGrantResponseDetails extends IAttestationResponse {
  type: "GrantDetails";
  data: {
    title: string;
    amount: string;
...
export interface IGrantResponse extends IAttestationResponse {
  ...
  details?: IGrantResponseDetails;
  milestones: IMilestoneResponse[];
  completed?: IGrantResponseUpdate;
  project: ISummaryProject;
  updates: IGrantResponseUpdate[];
