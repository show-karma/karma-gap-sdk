...
export class GAP extends Facade {
   ...
   * @returns
   */
  static getEAS(signer: SignerOrProvider) {
    const address = Networks[this.client.network].contracts.eas;
    return new ethers.Contract(address, EASABI.abi, signer as any);
  }
